...
| # | Tool ID | Tool Name | Workspace | Notes |
|---|---------|-----------|-----------|-------|
| 21 | `sketch-board` | Sketch Board | sketch-board/SketchBoardWorkspace | Full-featured infinite canvas whiteboard. Drawing, shapes, arrows, sticky notes, frames, embeds, multiplayer-ready. Dark/light theme sync. Chiko AI manifest (11 actions: readCurrentState, listShapes, zoomToFit, zoomTo, createShape, deleteSelected, selectAll, clearCanvas, setTool, exportInfo). Workspace events (dirty, progress, save). IndexedDB persistence. 0 TS errors. |
| 25 | `sketch-board-v2` | Sketch Board V2 | sketch-board-v2/SketchBoardV2Workspace | Excalidraw-powered (120K★ MIT) infinite canvas. Hand-drawn style diagrams, shapes (rectangle/ellipse/diamond/arrow/line/text), mermaid support, built-in shape library, eraser, laser pointer, frames. Dark/light theme sync via `theme` prop. Chiko AI manifest (20 actions: readCurrentState, listElements, getSelectedElements, scrollToContent, createRectangle/Ellipse/Diamond/Text/Arrow/Line, deleteSelected, selectAll, clearCanvas, setBackgroundColor, setActiveTool, toggleGrid, toggleZenMode, exportInfo, clearHistory, showToast). Workspace events (dirty, progress). localStorage persistence. PNG/SVG/JSON/clipboard export. CSS isolation overrides in globals.css. 0 TS errors. |
...
|--------|-------|-------------|
| **COMPLETE** | 25 | Sales Books (9) + Statement of Account + Contract & Agreement + Resume/CV + Certificate + Diploma + Ticket + Menu + ID Badge + Worksheet + Cover Letter + Color Palette + Background Remover + PDF Tools + Document Signer + Invoice & Accounting + Sketch Board + Sketch Board V2 + Presentation + AI Chat + AI Flow Builder |
