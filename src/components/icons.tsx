/**
 * DMSuite — SVG Icon Library
 * Inline SVG icons used across the AI suite dashboard.
...
export function IconWand(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M12.2 6.2L11 5" /><path d="M12.2 11.8L11 13" /><path d="M2 22l10-10" />
    </svg>
  );
}
...
export function IconReceipt(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <path d="M16 8h-6a2 2 0 100 4h4a2 2 0 010 4H8" /><path d="M12 17.5v-11" />
    </svg>
  );
}
...
export function IconCalculator(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      ...
      <line x1="16" y1="14" x2="16" y2="18" /><line x1="16" y1="10" x2="16" y2="10.01" />
      <line x1="12" y1="10" x2="12" y2="10.01" /><line x1="8" y1="10" x2="8" y2="10.01" />
      <line x1="12" y1="14" x2="12" y2="14.01" /><line x1="8" y1="14" x2="8" y2="14.01" />
      <line x1="12" y1="18" x2="12" y2="18.01" /><line x1="8" y1="18" x2="8" y2="18.01" />
    </svg>
  );
}
...
export function IconSubtitles(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect x="1" y="4" width="22" height="16" rx="2" /><path d="M5 12h2" /><path d="M9 12h10" /><path d="M5 16h10" /><path d="M17 16h2" />
    </svg>
  );
}
...
export function IconMagnet(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M6 15a6 6 0 0012 0V9H6v6z" /><path d="M6 9V6" /><path d="M18 9V6" /><path d="M6 6h4" /><path d="M14 6h4" />
    </svg>
  );
}
...
export const iconMap: Record<string, React.FC<IconProps>> = {
  grid: IconGrid, bell: IconBell, search: IconSearch,
  chevronLeft: IconChevronLeft, chevronRight: IconChevronRight, chevronDown: IconChevronDown, chevronUp: IconChevronUp,
  eye: IconEye, lock: IconLock,
  menu: IconMenu, x: IconX, sparkles: IconSparkles, crown: IconCrown,
  palette: IconPalette, fileText: IconFileText, video: IconVideo,
  penTool: IconPenTool, trendingUp: IconTrendingUp, settings: IconSettings,
  helpCircle: IconHelpCircle, zap: IconZap, clock: IconClock,
  folder: IconFolder, briefcase: IconBriefcase, play: IconPlay,
  layers: IconLayers, card: IconCard, share: IconShare,
  smartphone: IconSmartphone, layout: IconLayout, image: IconImage,
  bookOpen: IconBookOpen, chart: IconChart, scissors: IconScissors,
  wand: IconWand, monitor: IconMonitor, droplet: IconDroplet,
  type: IconType, box: IconBox, tag: IconTag,
  maximize: IconMaximize, shirt: IconShirt, building: IconBuilding,
  presentation: IconPresentation, receipt: IconReceipt, calculator: IconCalculator,
  target: IconTarget, shield: IconShield, award: IconAward,
  utensils: IconUtensils, home: IconHome, user: IconUser, users: IconUsers,
  mail: IconMail, tablet: IconTablet, calendar: IconCalendar,
  creditCard: IconCreditCard, film: IconFilm, messageCircle: IconMessageCircle,
  subtitles: IconSubtitles, repeat: IconRepeat, music: IconMusic,
  megaphone: IconMegaphone, hash: IconHash, mic: IconMic,
