// =============================================================================
// DMSuite — Diploma Designer Layers Panel
// Figma-style layer tree for the diploma document preview.
...
// ── Build layer tree from diploma form state ──
...
function useLayers(): Layer[] {
  ...
  const layers: Layer[] = [
    ...
    {
      id: "institution",
      label: form.institutionName || "Institution",
      section: "institution",
      icon: <LI d="M3 21h18M9 8h1M9 12h1M9 16h1M14 8h1M14 12h1M14 16h1M5 21V5a2 2 0 012-2h10a2 2 0 012 2v16" />,
      visible: !!form.institutionName,
    },

    // Program / Degree
    {
      id: "program",
      label: form.programName || "Program / Degree",
      section: "program",
      icon: <LI d="M22 10v6M2 10l10-5 10 5-10 5z" extra={<path d="M6 12v5c3 3 10 3 12 0v-5" />} />,
      visible: true,
    },
    ...
    // Resolution text
    {
      ...
      visible: !!form.resolutionText,
    },

    // Accreditation
    {
      id: "accreditation",
      label: form.accreditationBody || "Accreditation",
      section: "accreditation",
      icon: <LI d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />,
      visible: !!(form.accreditationBody || form.accreditationNumber),
    },

    // Date
    {
      id: "date",
      label: form.dateConferred ? `Conferred: ${form.dateConferred}` : "Date",
      section: "date",
      icon: <LI d="M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z" />,
      visible: !!form.dateConferred,
    },
    ...
    {
      id: "reference",
      label: form.serialNumber || form.registrationNumber || "Reference #",
      section: "reference",
      icon: <LI d="M12 20h9M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z" />,
      visible: !!(form.serialNumber || form.registrationNumber),
    },
  ];
...
interface DiplomaLayersPanelProps {
...
export default function DiplomaLayersPanel({ onOpenSection, onHoverSection, collapsed, onToggleCollapse }: DiplomaLayersPanelProps) {
