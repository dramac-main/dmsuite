          ...
          <div className="py-1">
            {profile?.is_admin && (
              <button
                ...
                className="w-full flex items-center gap-2.5 px-4 py-2 text-sm text-primary-600 dark:text-primary-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors text-left"
              >
