...
export const TEMPLATE_FIXED_THEMES: Record<string, TemplateColorTheme> = {
  ...
  "zigzag-overlay": {
    frontBg: "#FFFFFF", frontText: "#343434", frontTextAlt: "#E0E0E0",
    accent: "#303030", accentAlt: "#D0E85C",
    backBg: "#FFFFFF", backText: "#3A3A3A", backAccent: "#7E8D37",
    contactText: "#E0E0E0",
  },
  "hex-split": {
  ...
  "dot-circle": {
    frontBg: "#F8F8F8", frontText: "#2C2C2C", frontTextAlt: "#666666",
    accent: "#333333", backBg: "#F8F8F8", backText: "#666666",
    divider: "#E0E0E0", contactText: "#444444", contactIcon: "#666666",
  },
  "wave-gradient": {
    frontBg: "#FFFFFF", frontText: "#2D1B69", frontTextAlt: "#666666",
    accent: "#2D1B69", accentAlt: "#FF8C42",
    backBg: "#2D1B69", backText: "#FFFFFF", backAccent: "#FF8C42",
    contactText: "#333333",
  },

  // ── Classic / Corporate ──
  "circle-brand": {
    frontBg: "#F8F8F8", frontText: "#4A6FA5", frontTextAlt: "#666666",
    accent: "#4A6FA5", accentAlt: "#2D4A7A",
    backBg: "#4A6FA5", backText: "#FFFFFF",
    backAccent: "#B8D4F0",
    contactText: "#333333", contactIcon: "#4A6FA5",
  },
  "full-color-back": {
    frontBg: "#FFFFFF", frontText: "#2B5B84", frontTextAlt: "#666666",
    accent: "#2B5B84", accentAlt: "#4A7BA7",
    backBg: "#4A7BA7", backText: "#FFFFFF",
    contactText: "#666666", contactIcon: "#2B5B84",
  },
  "engineering-pro": {
    frontBg: "#F8F9FA", frontText: "#2C3E50", frontTextAlt: "#5DADE2",
    accent: "#5DADE2", accentAlt: "#2980B9",
    backBg: "#3498DB", backText: "#1B4F72", backAccent: "#2980B9",
    divider: "#BDC3C7",
    contactText: "#34495E", contactIcon: "#5DADE2",
  },
  "clean-accent": {
    frontBg: "#FFFFFF", frontText: "#E85A2B", frontTextAlt: "#666666",
    accent: "#E85A2B", accentAlt: "#DDDDDD",
    backBg: "#E85A2B", backText: "#FFFFFF",
    contactText: "#666666", contactIcon: "#E85A2B",
  },
  "nature-clean": {
    frontBg: "#F5F5F5", frontText: "#2C2C2C", frontTextAlt: "#6B8E7A",
    accent: "#6B8E7A",
    backBg: "#6B8E7A", backText: "#FFFFFF",
    contactText: "#6B8E7A", contactIcon: "#6B8E7A",
  },
  "diamond-brand": {
    frontBg: "#2E7D32", frontBgAlt: "#1B5E20", frontText: "#FFFFFF",
    accent: "#4CAF50", accentAlt: "#2E7D32",
    backBg: "#2E7D32", backText: "#FFFFFF",
    contactText: "#2E2E2E", contactIcon: "#4CAF50",
  },
  ...
  "neon-watermark": {
    frontBg: "#F5F3F0", frontBgAlt: "#2B5F7F", frontText: "#2B5F7F",
    frontTextAlt: "#FFFFFF", accent: "#2B5F7F", accentAlt: "#B8C5D1",
  ...
  "world-map": {
    frontBg: "#FFFFFF", frontText: "#2B5A9E", frontTextAlt: "#7B8A8B",
    accent: "#E67E22", accentAlt: "#2B5A9E",
    backBg: "#2B5A9E", backText: "#FFFFFF", backAccent: "#E67E22",
    contactText: "#34495E", contactIcon: "#E67E22",
  },
  "diagonal-gold": {
    frontBg: "#1A4A47", frontText: "#1A4A47", frontTextAlt: "#8B8B8B",
    accent: "#C9A961", backBg: "#1A4A47", backText: "#C9A961",
    backAccent: "#C9A961", divider: "#C9A961", contactText: "#FFFFFF",
    contactIcon: "#C9A961",
  },

  // ── Luxury ──
  "luxury-divider": {
    frontBg: "#F4D58D", frontText: "#1A4A5C", frontTextAlt: "#1A4A5C",
    accent: "#1A4A5C", backBg: "#1A4A5C", backText: "#F4D58D",
    backAccent: "#F4D58D", divider: "#F4D58D", contactText: "#1A4A5C",
    contactIcon: "#1A4A5C",
  },
  "social-band": {
    frontBg: "#3A5A4A", frontBgAlt: "#E8E6E1", frontText: "#FFFFFF",
    frontTextAlt: "#2C2C2C", accent: "#4A6B5A",
    backBg: "#3A5A4A", backText: "#FFFFFF",
    divider: "#2C2C2C", contactText: "#2C2C2C", contactIcon: "#2C2C2C",
  },
  "organic-pattern": {
    frontBg: "#4A5D52", frontBgAlt: "#FFFFFF", frontText: "#B8A882",
    frontTextAlt: "#6B7B73", accent: "#B8A882", accentAlt: "#3A4A42",
    backBg: "#4A5D52", backText: "#B8A882",
    divider: "#B8A882", contactText: "#B8A882", contactIcon: "#B8A882",
  },
  "celtic-stripe": {
    frontBg: "#FFFFFF", frontBgAlt: "#F8F8F8", frontText: "#2C2C2C",
    frontTextAlt: "#666666", accent: "#2C2C2C",
    backBg: "#2C2C2C", backText: "#FFFFFF",
  ...
  "gold-construct": {
    ...
    frontTextAlt: "#CCCCCC", accent: "#333333", accentAlt: "#1A1A1A",
